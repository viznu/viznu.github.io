...
// @ts-ignore
import aboutLinkScript from "../../components/scripts/aboutlink.inline"
// @ts-ignore
import contactScript from "../../components/scripts/contact.inline"
// @ts-ignore
import navCurrentScript from "../../components/scripts/navcurrent.inline"
...
function addGlobalPageResources(ctx: BuildCtx, componentResources: ComponentResources) {
  ...
  // "About" home link in the sidebar explorer
  componentResources.afterDOMLoaded.push(aboutLinkScript)

  // contact details under the social icons
  componentResources.afterDOMLoaded.push(contactScript)

  // marks the current menu item, and drops a heading that repeats it
  componentResources.afterDOMLoaded.push(navCurrentScript)
