...
<nav class="toc-index" aria-label="Poems">
  ...
  <a class="toc-row" href="/off-the-clock/poetry/an-ode-to-memory">
    <span class="toc-num">iii.</span>
    <span class="toc-title">an ode to memory</span>
    <span class="toc-leader"></span>
    <span class="toc-hint">the want of wanting</span>
  </a>
  <a class="toc-row" href="/off-the-clock/poetry/on-indian-sunlight">
    <span class="toc-num">iv.</span>
    <span class="toc-title">On Indian sunlight</span>
    <span class="toc-leader"></span>
    <span class="toc-hint">burnished sunlight</span>
  </a>
  <a class="toc-row" href="/off-the-clock/poetry/outta-the-sun-blasted-hills">
    <span class="toc-num">v.</span>
    <span class="toc-title">outta the sun-blasted hills of</span>
    <span class="toc-leader"></span>
    <span class="toc-hint">into the sea, again</span>
  </a>
  ...
  <a class="toc-row" href="/off-the-clock/poetry/the-flowers-remain">
    <span class="toc-num">vii.</span>
    <span class="toc-title">the flowers remain</span>
    <span class="toc-leader"></span>
